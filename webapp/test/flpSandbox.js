		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cartoon Enquiry",
									"targetURL": "#Barcodescannercartoonscanner-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Barcodescannercartoonscanner-display": {
								"semanticObject": "Barcodescannercartoonscanner",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Barcodescanner.cartoonscanner",
									"url": sap.ui.require.toUrl("Barcodescanner/cartoonscanner")
								}
							}
						}
					}
